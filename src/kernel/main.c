...
//=====================================================================
      //wuziqi
int iswin(int row,int column,int board[10][10])
{
	int i;
	int count=1;
	int j = board[row][column];
	for (i = 1; i < 6; i++)
	{
		if (column + i<10&&board[row][column + i] == j)
		{
		count++;
		}
		else
	...
	for (i =1; i < 6; i++)
	{
		if (column - i>-1&&board[row][column - i] == j)
		{
		count++;
		}
		else
	...
	for (i = 1; i < 6; i++)
	{
	if (row + i<10 && board[row+i][column] == j)
	{
	count++;
	}
	else
	...
	for (i = 1; i < 6; i++)
	{
	if (row - i>-1 && board[row-i][column] == j)
	{
	count++;
	}
	else
	...
	for (i = 1; i < 6; i++)
	{
	if (column + i<10 && row +i<-1&& board[row+i][column + i] == j)
	{
	count++;
	}
	else
	...
	for (i = 1; i < 6; i++)
	{
	if (column - i>-1 && row-i>10 && board[row-i][column - i] == j)
	{
	count++;
	}
	else
	...
	for (i = 1; i < 6; i++)
	{
	if (column + i<13 && row-i>0 && board[row - i][column + i] == j)
	{
	count++;
	}
	else
...
int wzq_input(int turn,int board[10][10],int fd_stdin,int fd_stdout)
{
	int row,column ;
	char szCmd[80]={0};
	L1:	printf("Please input row number:");
...
void wzq(int fd_stdin,int fd_stdout)
{
...
{
display(board);
turn =wzq_input(turn,board,fd_stdin,fd_stdout);
}
...
{
int index, i;
for (i = index = random() % 16; index<16; ++index)
if (a_ival[index] == 0)
return index;
...
if (style == 0)
{
a_ival[i - 4] = a_ival[i - 4] + a_ival[i];
a_ival[i] = 0;
a_stop[i % 4] = i - 4;
}
IsChange = 1;
...
if (style == 0)
{
a_ival[i - 1] = a_ival[i - 1] + a_ival[i];
a_ival[i] = 0;
a_stop[i / 4] = i - 1;
}
IsChange = 1;
...
void TestA()
{
	...
	clear();
	printf("                        ========================================\n");
	printf("                             (:    Our_Linux v@1.$1.&1     :)           \n");
	printf("                              (:  Micro Kernel Window 11  :) \n");
	printf("                               (:      Welcome !         :)\n");
        printf("                                (:     to window 11!    :)\n"); 
printf("%c       ",2);
	printf("                        ========================================\n");
	...
	while (1) {
		printl("[please your order [Order]:] \n");
...
//=================================================
		...
		{
			printf("HUANG RI HUI 1256234 !   ~~(^_^)~~\n");
                        printf("ZHANG JIA QI 1352863 !    ~~(^_^)~~\n");		
			continue;
		...
		{
			wzq( fd_stdin,  fd_stdout);
		} 
                else if (strcmp(rdbuf, "chat") == 0)
		{
                        clear();
			printf("                        =============================================\n");
			printf("                                   Chatting machine!            \n");
			printf("                                Just talk to me (= .=) \n");
			printf("                                   example:\n");
			printf("                                   Hello! \n");
			printf("                        You can input helpInChat to find some examples\n");
			printf("                        =============================================\n");
        		printf("\n\n\n");
			printf("                          You can ask me some questions0.0\n");
	...
	while (1) {
		...
		rdbuf[r] = 0;
	 	//show();
                if(strcmp(rdbuf,"helpInChat")==0)
                {
                   printf("Who are you\n");
                   printf("Where are you from\n");
                   printf("Which is you favourite course?\n");
                   printf("Tell me a joke\n");
                   printf("Tell me zhang's mobile phone number\n");
	           printf("Exit \n");
			

                   continue;
                }
                else if (strcmp(rdbuf, "Who are you") == 0)
                {
			printf("I'm a student from Tongji University\n");
			continue;
                }
		else if (strcmp(rdbuf, "Where are you from") == 0)
		{
			...
			continue;
                ...
                else if (strcmp(rdbuf, "Which is you favourite course?") == 0)
		{
			printf("My favourite course is Operating System ^ .^ ~\n");
			continue;
		}
		else if (strcmp(rdbuf, "Tell me a joke") == 0)
		{

			printf("huang rihui works very hard !  \n");
			continue;
		}
		else if(strcmp(rdbuf,"Tell me zhang's mobile phone number")==0)
		{
			printf("13423436858 \n");
			continue;
                }
...
void help()
{
	...
	printf("5. game          : 2048\n");
	printf("6. game2         : five son chest\n");
	printf("7. game3         : 3line chest\n");
        printf("8. chat          : Simple Ask and Answer\n");
        printf("9. information   : Show our information\n");
        printf("10.test2         : A small boat\n");
	printf("==============================================================================\n");		
}
